...
{
    public partial class TicTacToeMedium : Form
    {
        ...
        {
            Button[] btnArr = new Button[] {button1,button2,button3,button4,
                                            button5,button6,button7,button8,
                                            button9,button10,button11,button12,
                                            button13,button14,button15,button16};

            //board with 1 dimensional indexing:
            string[] board = { button1.Text,button2.Text,button3.Text,button4.Text,
            ...
            if (board[index] == "") //if the button is not pressed
            {
...

                {
                    ...
                    btnArr[(pcMove.row * 4) + pcMove.col].Text = "o";
                    board[(pcMove.row * 4) + pcMove.col] = "o";
                    btnArr[(pcMove.row * 4) + pcMove.col].Enabled = false;
        ...
        public class Game
        {
            ...
            public int evaluate(string[] board)
            {
                ...
                for (int row = 0; row < 4; row++)
                {
                    if ( 
                         (
                          board[row * 4 + 0] == board[row * 4 + 1] &&
                          board[row * 4 + 1] == board[row * 4 + 2] &&
                          board[row * 4 + 0] != ""
                         ) 
                         || 
                         (
                          board[row * 4 + 1] == board[row * 4 + 2] && 
                          board[row * 4 + 2] == board[row * 4 + 3] &&
                          board[row * 4 + 1] != ""
                         ) 
                       )
                    {
                        if (
                            (
                             board[row * 4 + 0] == opponent &&
                             board[row * 4 + 1] == opponent &&
                             board[row * 4 + 2] == opponent
                            )
                            ||
                            (
                             board[row * 4 + 1] == opponent &&
                             board[row * 4 + 2] == opponent &&
                             board[row * 4 + 3] == opponent
                            )
                           )
                            return +10;
                        else if (
                                 (
                                  board[row * 4 + 0] == player &&
                ...
                for (int col = 0; col < 4; col++)
                {
                    if (
                        (
                         board[0 * 4 + col] == board[1 * 4 + col] &&
                         board[1 * 4 + col] == board[2 * 4 + col] && 
                         board[0 * 4 + col] != ""
                        )
                        ||
                        (
                         board[1 * 4 + col] == board[2 * 4 + col] &&
                         board[2 * 4 + col] == board[3 * 4 + col] &&
                         board[0 * 4 + col] != ""
                        )
                       )
                    {
                        if (
                            (
                             board[0 * 4 + col] == opponent &&
                             board[1 * 4 + col] == opponent &&
                             board[2 * 4 + col] == opponent
                            )
                            ||
                            (
                             board[1 * 4 + col] == opponent &&
                             board[2 * 4 + col] == opponent &&
                             board[3 * 4 + col] == opponent
                            )
                           )
                            return +10;
                            ...
                            (
                             board[0 * 4 + col] == player &&
                             board[1 * 4 + col] == player &&
                             board[2 * 4 + col] == player
                            )
                            ||
                            (
                             board[1 * 4 + col] == player &&
                             board[2 * 4 + col] == player &&
                             board[3 * 4 + col] == player
                            )
                           )
                            return -10;
                    }
                ...
                if (
                    (
                     board[0 * 4 + 0] == board[1 * 4 + 1] &&
                     board[1 * 4 + 1] == board[2 * 4 + 2] &&
                     board[0 * 4 + 0] != ""
                    )
                    ||
                    (
                     board[1 * 4 + 1] == board[2 * 4 + 2] &&
                     board[2 * 4 + 2] == board[3 * 4 + 3] &&
                     board[1 * 4 + 1] != ""
                    )
                    ||
                    (
                     board[0 * 4 + 1] == board[1 * 4 + 2] &&
                     board[1 * 4 + 2] == board[2 * 4 + 3] &&
                     board[0 * 4 + 1] != ""
                    )
                    ||
                    (
                     board[1 * 4 + 0] == board[2 * 4 + 1] &&
                     board[2 * 4 + 1] == board[3 * 4 + 2] &&
                     board[1 * 4 + 0] != ""
                    )
                   )
                {
                    if (
                        (
                         board[0 * 4 + 0] == opponent &&
                         board[1 * 4 + 1] == opponent &&
                         board[2 * 4 + 2] == opponent
                        )
                        ||
                        (
                         board[1 * 4 + 1] == opponent &&
                         board[2 * 4 + 2] == opponent &&
                         board[3 * 4 + 3] == opponent
                        )
                        ||
                        (
                         board[0 * 4 + 1] == opponent &&
                         board[1 * 4 + 2] == opponent &&
                         board[2 * 4 + 3] == opponent
                        )
                        ||
                        (
                         board[1 * 4 + 0] == opponent &&
                         board[2 * 4 + 1] == opponent &&
                         board[3 * 4 + 2] == opponent
                        )
                       )
                        return +10;
                    else if (
                ...
                if (
                    (
                     board[0 * 4 + 2] == board[1 * 4 + 1] &&
                     board[1 * 4 + 1] == board[2 * 4 + 0] &&
                     board[0 * 4 + 2] != ""
                    )
                    ||
                    (
                     board[0 * 4 + 3] == board[1 * 4 + 2] &&
                     board[1 * 4 + 2] == board[2 * 4 + 1] &&
                     board[0 * 4 + 3] != ""
                    )
                    ||
                    (
                     board[1 * 4 + 2] == board[2 * 4 + 1] &&
                     board[2 * 4 + 1] == board[3 * 4 + 0] &&
                     board[1 * 4 + 2] != ""
                    )                    
                    ||
                    (
                     board[1 * 4 + 3] == board[2 * 4 + 2] &&
                     board[2 * 4 + 2] == board[3 *4 + 1] &&
                     board[1 * 4 + 3] != ""
                    )
                   )
                {
                    if (
                        (
                         board[0 * 4 + 2] == opponent &&
                         board[1 * 4 + 1] == opponent &&
                         board[2 * 4 + 0] == opponent
                        )
                        ||
                        (
                         board[0 * 4 + 3] == opponent &&
                         board[1 * 4 + 2] == opponent &&
                         board[2 * 4 + 1] == opponent
                        )
                        ||
                        (
                         board[1 * 4 + 2] == opponent &&
                         board[2 * 4 + 1] == opponent &&
                         board[3 * 4 + 0] == opponent
                        )
                        ||
                        (
                         board[1 * 4 + 3] == opponent &&
                         board[2 * 4 + 2] == opponent &&
            ...
            public int minimax(string[] board, int depth, bool isMax)
            {
                ...
                if (isMovesLeft(board) == false || depth == 5)
                    return 0;
